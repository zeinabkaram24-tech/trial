    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="font-bold tracking-tight text-white flex items-center gap-2">
                ...
                <span className="bg-amber-400/20 text-amber-300 px-2 py-0.5 rounded-full text-[11px] font-semibold border border-amber-400/30">
                  Nile Egyptian Schools
                </span>
              </div>
              <p className="text-slate-300 text-[11px] flex items-center gap-1.5">
                <span>بوابة متابعة المرحلة الابتدائية</span>
                <span>•</span>
                <span className="font-medium text-amber-200">جريد 2 (Grade 2)</span>
              </p>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-semibold text-slate-500 ml-1">الفصل:</span>
        ...
        <div className="flex items-center gap-2 flex-wrap text-xs">
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200">
            ...
            <span className="text-slate-600 font-medium">البلوك:</span>
            <select
          ...
          <div className="flex items-center gap-1.5 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200">
            ...
            <span className="text-slate-600 font-medium">الأسبوع:</span>
            <select
